// NoService/services/NoCluster/entry.js
// Description:
// "NoCluster/entry.js" description.
...
function Service(Me, NoService) {
  ...
  // import NoService to NoCluster module
  const NoCluster = new (require('./NoCluster'))(Me, NoService);
  ...
  ss.def('ServiceFunction', (json, entityID, returnJSON)=> {
    NoCluster.whateverfunction((err, msg)=> {
